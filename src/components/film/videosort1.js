...
class VideoSort extends React.Component {
    ...
    //获取所有电影
    getAllFilm = async (props) => {
        const res = await this.getAllFilmRes();
        console.log('哈哈', res);
        if (res.code === 0) {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Row gutter={[16, 24]}>
                    {
                        this.state.allFilmArr && this.state.allFilmArr.map((item, index) => {
                            return <div key={index} className="videodiv" >
                                <a href=''>
                                    <img src={this.state.allFilmArr[0].imagePath} className="videoimg"></img>
                                </a>
                                <a>
                                    <span className='videofont'>{this.state.allFilmArr[0].name}
                                    </span>
                                </a>
                            </div>
                        })
                    }
                     {
                        this.state.allFilmArr && this.state.allFilmArr.map((item, index) => {
                            return <div key={index} className="videodiv" >
                                <a href=''>
                                    <img src={this.state.allFilmArr[0].imagePath} className="videoimg"type=""></img>
                                </a>
                                <a>
                                    <span className='videofont'>{this.state.allFilmArr[0].name}
                                    </span>
                    ...
                    <Col className="gutter-row" span={6}>
                        <div className="videodiv" ><a href=''><img src={this.state.allFilmArr[2].imagePath} className="videoimg"></img></a>
